...
- Backend dependency updates (NuGet): `.claude/skills/update-backend-deps/SKILL.md`
- Frontend dependency updates (npm): `.claude/skills/update-frontend-deps/SKILL.md`
